            ...
            <Container classname="projects-container">
                ...
                <div className="previous-work-wrapper">
                    <div className="previous-work">
                        ...
                        <a href="https://github.com/schrolan/react-mhw-companion" target="_blank"><h4>GitHub repository where you can learn what technology was used to create the site.</h4></a>
                        <a href="http://3.141.0.125:3000/" target="_blank"><h4>Deployed site using aws.</h4></a>
                        </h3>
                    ...
                    <div className="previous-work-2">
                        <h3 className="previous-work-2-text">
                            ...
                            <a href="https://github.com/schrolan/react-hand-me-a-book" target="_blank"><h4>GitHub repository where you can learn what technology was used to create the site.</h4></a>
                            <a href="http://3.22.112.97/" target="_blank"><h4>Deployed site using aws.</h4></a>
                        </h3>
                    ...
                    <div className="previous-work-3">
                        <h3 className="previous-work-3-text"><a href="https://github.com/schrolan?tab=repositories" target="_blank">Here is my github repositories page.</a></h3>
                    </div>
                </div>
